...
# --- ลิงก์ต่างๆ ---
LINE_FREE_ADMIN = "https://lin.ee/aw2rc3s"           # แอดมินกลุ่มฟรี (เดิม)
LINE_PREMIUM_ADMIN = "https://tinyurl.com/ufa345-24" # 1. ติดต่อแอดมิน Premium
LINE_DEPOSIT_WITHDRAW = "https://lin.ee/oi2hRtr"      # 2. ติดต่อแอดมินฝาก/ถอน
LOGIN_URL = "https://member.ufa345word.com/login"    # 3. เข้าสู่ระบบ
    ...
    for route in CHANNEL_ROUTES[int(chat_id)]:
        try:
            ...
            if route["type"] == "free":
                ...
                free_keyboard = InlineKeyboardMarkup([[InlineKeyboardButton("💬 ติดต่อแอดมินเพื่อรับชม", url=LINE_FREE_ADMIN)]])
                ...
                # ปุ่มสำหรับกลุ่ม Premium (จัดเป็นแถวละ 2 ปุ่ม)
